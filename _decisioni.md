...
## 2026-06 (giugno)
- **[Organizzazione / AI]** (15/06) **Direttiva: migrare da OpenAI a Bedrock dove possibile.** Razionale: ~**20.000€ di crediti Bedrock** nel prossimo anno → si può spendere fino a **3x** rispetto a OpenAI; lo spending va aumentato per non perdere i crediti. **Non tutte** le app vanno migrate (serve un **piano**), ma di default si usa Bedrock; si usano altri tool solo dove il progetto lo richiede (es. costi troppo alti, come Prima). [[Casartelli — Industrial Knowledge]] andrà **sicuramente su Bedrock**. Limiti attuali Bedrock: modelli vecchi/aggiornati lentamente, manca il Code Interpreter come orchestratore. → [[LAIF Tech Stack]], [[Casartelli — Industrial Knowledge]]
- **[Lamonea]** (12/06) **Release parziale + go-live anticipato** in produzione anziché completamento totale (avallato da [[Marco Vita]]); ora **LIVE** su `lamonea.app`. → [[Lamonea — Gestionale / CRM]]
- **[Andriani]** (12/06) Prodotti **in gamma ma NON a listino → non ordinabili** (blocco finché il listino non è aggiornato in ARCA). → [[Andriani — Automazione ordini]]
- **[Umbra]** (11-12/06) Per le **Promozioni WOW** si agisce sui **criteri di selezione**, **senza toccare il modello esistente** (un "pozzo nero"); intervento sul modello = piano B. → [[Umbra — Improvement recommender e modulo marketing]]
- **[Sebi Group]** (11-12/06) **Nessun lavoro operativo del team fino a contratto firmato**; si vende il **progetto completo** (app + formazione), non solo la formazione da 2.000€. → [[Sebi Group — Acquisizione database/mailing e app export]]
