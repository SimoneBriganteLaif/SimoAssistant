...
> Lista **viva e NON storica** di fili aperti e domande pronte. Regola: quando un item è risolto, la conoscenza va nelle note / `_decisioni.md` e **l'item qui si cancella** (lo storico sta in `_log.md`, non qui). Aggiungere qui ogni volta che Simone dice "questo lo approfondiamo dopo".

## Da approfondire (su richiesta di Simone)
- [ ] **Merlino / `core_knowledge`** — approfondire in vista della call di presentazione del nuovo **project management** (priorità dichiarata da Simone). → [[Merlino]] · sorgente di Lorenzo: `laif-factory` `wiki/process/lifecycle.md` (+ mirror `.html`).
...
## Domande pronte (esempi da farti)
- Iteriamo sul `lifecycle.html`/`.md` di Lorenzo per la presentazione PM & Staffing: cosa vuoi cambiare/aggiungere?

## Metodo
- **Niente più backfill storico** prima dell'11/05/2026: da qui in avanti solo novità *future* (via `/scoperta`).
